...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BINLIBDEST': '/opt/python3/lib/python3.11',
 ...
 'CONFIG_ARGS': "'--prefix=/opt/python3' '--with-openssl=/opt/openssl' "
                "'--with-openssl-rpath=auto'",
 'CONFINCLUDEDIR': '/opt/python3/include',
 'CONFINCLUDEPY': '/opt/python3/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/opt/Python-3.11.11/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/opt/Python-3.11.11/lcov-report',
 ...
 'DESTDIRS': '/opt/python3 /opt/python3/lib /opt/python3/lib/python3.11 '
             '/opt/python3/lib/python3.11/lib-dynload',
 'DESTLIB': '/opt/python3/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/opt/python3/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/opt/python3/include /opt/python3/include '
                   '/opt/python3/include/python3.11 '
                   '/opt/python3/include/python3.11',
 'INCLUDEDIR': '/opt/python3/include',
 'INCLUDEPY': '/opt/python3/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/opt/python3/lib/python3.11',
 ...
 'LIBPL': '/opt/python3/lib/python3.11/config-3.11-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/opt/python3/lib/python3.11',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/opt/openssl/include',
 'MODULE__HASHLIB_DEPS': './Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/opt/openssl/lib  '
                            '-Wl,--enable-new-dtags,-rpath=/opt/openssl/lib  '
                            '-lcrypto',
 ...
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/opt/openssl/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/opt/openssl/lib  '
                        '-Wl,--enable-new-dtags,-rpath=/opt/openssl/lib -lssl '
                        '-lcrypto',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/opt/openssl/include',
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './opt/python3',
 'WASM_STDLIB': './opt/python3/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/opt/Python-3.11.11',
 'abs_srcdir': '/opt/Python-3.11.11',
